...
from nnunetv2.nets.UMambaEncCBAM_3d import get_umamba_enc_3d_from_plans
from nnunetv2.nets.UMambaEncCBAM_2d import get_umamba_enc_2d_from_plans
from nnunetv2.training.lr_scheduler.polylr import PolyLRScheduler    #Modif by Mariana
import torch    #Modif by Mariana
"""
class nnUNetTrainerUMambaEncCBAM(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        print("UMambaEncCBAM: {}".format(model))
...
class nnUNetTrainerUMambaEncCBAM(nnUNetTrainer):
    ...
    # IMPORTANT: pas @staticmethod, on utilise self.plans_manager etc.
    def build_network_architecture(self,
        ...
        # On ignore architecture_class_name/arch_init_kwargs parce qu'on force notre archi UMambaEncCBAM
        ...
        print("UMambaEncCBAM:", type(model).__name__)
        return model