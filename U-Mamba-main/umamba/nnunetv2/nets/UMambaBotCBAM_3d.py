...
def get_umamba_bot_3d_from_plans(
    ...
    num_stages = len(configuration_manager.pool_op_kernel_sizes)+1
    ...
    segmentation_network_class_name = 'UMambaBotCBAM'
    network_class = UMambaBotCBAM
    kwargs = {
        'UMambaBotCBAM': {
            'conv_bias': True,
    ...
    model = network_class(
        ...
        conv_op=conv_op,
        kernel_sizes=configuration_manager.conv_op_kernel_sizes,
